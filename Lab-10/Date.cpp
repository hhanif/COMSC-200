...
//overloaded postfix increment operator; note that the dummy integer paramete does not have a parameter name
Date Date::operator++( int )
{
    ...
    return temp; // vallue return; not reference return
} // end function operator++

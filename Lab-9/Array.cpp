...
Array::Array(int arraySize)
{
    ...
    ptr = new int[size]; // create space for pointer-based array element
...
{
    if(&right != this) // avoid slef-assignment
    {
        //for Arrays of different dize, deallocate original
...
// const reference return creates a modified lvalue
